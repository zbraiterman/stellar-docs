...
This section requires you to have a funded Keypair to use with Stellar's Testnet. You can create and fund one using the [Stellar Lab](https://laboratory.stellar.org/#account-creator?network=testnet).
